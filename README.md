...
***
### 功能性需求
1. 簡單快速的搭建個人部落格，依據適用人群提供不同的服務
  - 提供已經做好的網頁模版，只需在模板上輸入文章標題、內容、圖片..等，就能輕鬆搭建個人部落格。(適用對象：對網站架設有基本知識的人)
  - 我們會親自聯絡您，並且會有專人根據您的需求建立專屬的個人部落格。(適用對象：遊民、願意幫助遊民的商家)
2. 線上客服人員
3. 提供相關的政府補助資訊
4. 網站使用說明
5. 捐助功能
...
3. 可靠度(reliability)：系統可24h上線，除非伺服器所在地停電。
